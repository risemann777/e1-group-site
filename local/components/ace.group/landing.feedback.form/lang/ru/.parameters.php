...
$MESS ['MFP_GOOGLE_RECAPTCHA'] = "Использовать Google reCaptcha для неавторизованных пользователей";
$MESS ['MFP_FORM_NAME'] = "Имя формы";
$MESS ['MFP_FORM_TEXT'] = "Связаться с нами";
...
$MESS ['MFP_FORM_THEME_LIGHT'] = "Светлая";
